(()=>{
  ...
  if(ogDesc) ogDesc.content=extra[document.documentElement.lang]?.metaDescription||extra.ms.metaDescription;

  if(typeof setLanguage==='function'){
    const lang=['ms','en','ar'].includes(document.documentElement.lang)?document.documentElement.lang:'ms';
    setLanguage(lang);
  }
})();